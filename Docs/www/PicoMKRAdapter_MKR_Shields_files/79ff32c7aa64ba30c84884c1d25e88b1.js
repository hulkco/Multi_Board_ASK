...
;
goog.provide("jive.ps.nitro.content.statusLevelImage");jive.ps.nitro.content.statusLevelImage=function(opt_data,opt_sb){var output=opt_sb||new soy.StringBuilder;output.append('\x3cspan class\x3d"j-status-levels j-gamification-status-level"\x3e\x3cimg src\x3d"',soy.$$escapeHtml(opt_data.imagePath),'" alt\x3d"',soy.$$escapeHtml(opt_data.title),'" title\x3d"',soy.$$escapeHtml(opt_data.title),'" /\x3e\x3c/span\x3e');return opt_sb?"":output.toString()};
;
/*
 * Copyright (C) 1999-2015 Jive Software. All rights reserved.
 *
